        ...
        <form onSubmit={handleSubmit} className="bg-blue-500 space-y-4 md:space-y-6" action="#">
          ...
          <div className='text-left'>
            ...
            >
              ...
              <option value="Conférence et congrès">Conférence et congrès</option>
          ...
          <p className="text-xl font-light text-white dark:text-indigo-400">
            Je suis un gestionnaire d'évènement  <Link href="/dasbordEvent" className="font-medium text-white hover:underline dark:text-primary-500">Mise à jour de produit</Link>
          </p>
        </form>
      </div>
      <ToastContainer />
