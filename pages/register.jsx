                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-indigo-800 dark:border-indigo-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleSubmit} className=" space-y-4 md:space-y-6" action="#">
                                ...
                                <label htmlFor="phone" className="block mb-2 text-sm font-medium text-indigo-700 dark:text-white">Votre numéro de téléphone</label>
                                <PhoneInput
                                    country={country}
                                ...
                                <p className="text-sm font-light text-indigo-500 dark:text-indigo-400">
                                    J'ai déjà un compte  <Link href="/" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Connection</Link>
                                </p>
                            </form>
                        </div>
                    </div>
