...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const res = await axios.post('http://127.0.0.1:8025/token', formDataToSend);
      const res = await axios.post('https://test004.entourage.club/token', formDataToSend);
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="remember" className="text-indigo-500 dark:text-indigo-300">Se souvenir de moi</label>
                    </div>
                  </div>
